...
public class Example_Report {
	...
	public static void main(String[] args)
	{
        ...
        /*String str = driver.findElement(By.className("field-validation-error")).getText();
        assertTrue(str.equals("* User Name required"));
        Assert.assertEquals("* User Name required", str);*/
