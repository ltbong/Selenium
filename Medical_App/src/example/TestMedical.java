...
public class TestMedical {
	...
	public static void main(String[] args) throws InterruptedException, MalformedURLException {
		...
		// capabilities.setCapability("deviceName", "Redmi");
         ...
         WebDriverWait myDynamicElement1 = new WebDriverWait(driver, 15);
		 myDynamicElement1.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.TextView[@text='anusha shende']")));
         driver.findElement(By.xpath("//android.widget.TextView[@text='anusha shende']")).click();
         driver.findElement(By.id("android:id/home")).click();
         driver.findElement(By.id("android:id/home")).click();
         driver.findElement(By.xpath("//android.widget.TextView[@text='My Patients']")).click();
         driver.findElement(By.xpath("//android.widget.Button[@text='New Patient']")).click();
	}
