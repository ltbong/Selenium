...
public class Retrieve extends SeleneseTestBase{
     WebDriver driver;
     String url ="";
     @BeforeTest
public void setUp() throws Exception{
     ...
     public void CreateDB() throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException{
      ...
      Class.forName("com.microsoft.jdbc.sqlserver.SQLServerDriver");
         ...
         String url ="jdbc:sqlserver://RAVITEJA;instanceName=SQLEXPRESS;DatabaseName=OBTS;";
         ...
         ResultSet resultSet = statement
                 .executeQuery("SELECT * FROM LoginUsers");
